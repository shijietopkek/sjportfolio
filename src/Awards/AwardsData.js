const AwardsData = [
    ...
    },
    {
        ...
        description:'For someone whose prior experience in programming is limited to Python, C++ was indeed a steep learning curve for me. But it was the prerequisite for NOI, so with little choice I grit my teeth and set about conquering it. The competition opened my eyes to a world beyond Python, where not everything is as smooth, simple and straightforward as desired. In the end, I was glad to have acquired C++ skills, albeit at an entry level.',
        imglinks:[['https://i.imgur.com/kHOeDt6.png','A sample solution from one of the NOI questions. The unfamiliar syntax and abstract programming paradigm result in a steep learning curve, especially for Python users.']]
    },
    {
        id:6,
        placing:'3rd',
        title:'Code::XtremeApps:: 2016',
        description:'It was my first experience in an infocomm-related competition. We were given 24 hours to develop an application revolving around Financial Technology. Sleep was not included in that 24 hours. Nevertheless, we thoroughly enjoyed ourselves. After all, pulling an all nighter while representing the school is not something everyone gets to brag about.',
